...
const projects: Project[] = [
  ...
  {
    title: "Pokemon Plushies Online",
    description: "E-commerce web app for selling Pokemon plushies and merchandise. My first complete web application!",
  ...
  },
  {
    ...
    description: "Java-based game featuring Legendary Pokemon. One of my earliest programming projects!",
    period: "Oct - Dec 2011",
    category: "personal",
